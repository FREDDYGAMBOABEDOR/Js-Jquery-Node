...
let substring_str = str.substring(5, 10)// y termina en el 10
console.log(substring_str)

let substr_str = str.substr(5, 10) // comineza en el 5 y pasa 10 palabras
...
// Con este metodo remplazmos todas las palabras a cambiar
