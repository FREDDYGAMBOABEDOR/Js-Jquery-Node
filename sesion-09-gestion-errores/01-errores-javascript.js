...
// InternalError= fallas en recursividad
 //SyntaxError = mal escrito
//  TypeError= error variable definida con de bollean a strim
//  RangeError = error de rango en lista
//  ReferenceError = referencia que no existe 
